...
const profileCopy={
  he:{basic:'פרופיל בסיסי ממידע ציבורי',pending:'פרטי הפרופיל יושלמו לאחר אימות מול המרפאה.',overview:'אודות הרופא',education:'לימודים והכשרה',credentials:'התמחות ותעודות',services:'שירותי המרפאה',practical:'מידע שימושי',languages:'שפות',insurance:'הסדרים וביטוחים',hours:'שעות פעילות',accessibility:'נגישות',missing:'המידע טרם נוסף',website:'עמוד המרפאה',booking:'קביעת תור'},
  ar:{basic:'ملف أساسي من معلومات عامة',pending:'سيتم استكمال الملف بعد التحقق مع العيادة.',overview:'نبذة عن الطبيب',education:'الدراسة والتدريب',credentials:'التخصص والشهادات',services:'خدمات العيادة',practical:'معلومات مفيدة',languages:'اللغات',insurance:'التأمين والترتيبات',hours:'ساعات العمل',accessibility:'إمكانية الوصول',missing:'لم تتم إضافة المعلومات بعد',website:'صفحة العيادة',booking:'حجز موعد'},
  en:{basic:'Basic profile from public information',pending:'Profile details will be completed after verification with the clinic.',overview:'About the doctor',education:'Education and training',credentials:'Specialty and credentials',services:'Clinic services',practical:'Practical information',languages:'Languages',insurance:'Insurance',hours:'Opening hours',accessibility:'Accessibility',missing:'Information not added yet',website:'Clinic page',booking:'Book appointment'}
};
const modalCopy={
  he:{close:'סגירה',verified:'מידע מאומת',public:'מידע ציבורי',sample:'פרופיל לדוגמה',hoursNote:'שעות הפעילות טרם פורסמו או אומתו מול המרפאה',contact:'יצירת קשר',location:'מיקום המרפאה',missingTitle:'תוכן להמחשה בלבד',missingBody:'האודות, הלימודים, השירותים, השפות, ההסדרים והנגישות הומצאו לצורך עיצוב ואינם מידע מאומת על ד״ר כרם סמארה.',sampleTitle:'תוכן להמחשה בלבד',sampleBody:'האודות, הלימודים, השירותים, השפות, ההסדרים והנגישות הומצאו לצורך עיצוב ואינם מידע מאומת על ד״ר כרם סמארה.',noWebsite:'לא פורסם אתר רשמי'},
  ar:{close:'إغلاق',verified:'معلومات موثقة',public:'معلومات عامة',sample:'ملف تجريبي',hoursNote:'لم تُنشر ساعات العمل أو يتم التحقق منها مع العيادة بعد',contact:'تواصل',location:'موقع العيادة',missingTitle:'محتوى توضيحي فقط',missingBody:'النبذة والدراسة والخدمات واللغات والتأمين وإمكانية الوصول مختلقة لأغراض التصميم وليست معلومات موثقة عن د. كرم سمارة.',sampleTitle:'محتوى توضيحي فقط',sampleBody:'النبذة والدراسة والخدمات واللغات والتأمين وإمكانية الوصول مختلقة لأغراض التصميم وليست معلومات موثقة عن د. كرم سمارة.',noWebsite:'لم يُنشر موقع رسمي'},
  en:{close:'Close',verified:'Verified information',public:'Public information',sample:'Sample profile',hoursNote:'Opening hours have not yet been published or confirmed with the clinic',contact:'Contact',location:'Clinic location',missingTitle:'Demonstration content only',missingBody:'The overview, education, services, languages, insurance, and accessibility were invented for design purposes and are not verified information about Dr. Karam Samara.',sampleTitle:'Demonstration content only',sampleBody:'The overview, education, services, languages, insurance, and accessibility were invented for design purposes and are not verified information about Dr. Karam Samara.',noWebsite:'No official website published'}
};
